...
export const NavBar = ({ setRoute, apiUrl, OP }) => {
  return (
    <div
      className="navBar shadow-4"
      style={
        apiUrl === OP
          ? { backgroundColor: "rgba(256, 256, 256, 0.2)" }
          : { backgroundColor: "rgba(66, 235, 210, 0.3)" }
      }
    >
      <button
        label="egreso"
        className="navBtn shadow-3 grow"
      ...
      <button
        label="stats"
        className="navBtnR shadow-3 grow"
